...
export function Sidebar({setUser}) {
  ...
  const Menus = [
    ...
    { title: "Insumos", src: "insumo", gap: true, link:"/insumos", rol:[1,2]},
    { title: "Proveedores", src: "proveedor", gap: false, link:"/proveedores", rol:[1,2]},
    { title: "Compras", src: "compra", gap: false, link:"/compras", rol:[1,2]},
    { title: "Productos", src: "producto", gap: true, link:"/productos", rol:[1]},
    { title: "Clientes", src: "cliente", gap: false, link:"/clientes", rol:[1]},
    { title: "Ventas", src: "venta", gap: false, link:"/ventas", rol:[1]},
